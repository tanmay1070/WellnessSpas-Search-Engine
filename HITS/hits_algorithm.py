...
hub_score_file = open("/Users/tathyapatel/Documents/IR/CarsSearchEngine/HITS/precomputed_scores/hub_score_1", 'w')
authority_score_file = open("/Users/tathyapatel/Documents/IR/CarsSearchEngine/HITS/precomputed_scores/authority_score_1", 'w')
...
def get_webgraph_inlinks():
    inlinks_file = open("part-r-00000", 'r').readlines()
